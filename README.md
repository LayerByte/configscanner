...
Configscanner is a defensive cybersecurity and system-administration project written in Modern Java. It focuses on read-only analysis, validation, clear output, and safe handling of user-provided files, URLs, hosts, or text.
...
`mvn package`
`java -cp target/classes com.layerbyte.configscanner.App file sample.log`

## Example

```text
java -cp target/classes com.layerbyte.configscanner.App net
```
