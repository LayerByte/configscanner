package com.layerbyte.configscanner;
...
public final class App {
    private static final String PROJECT_NAME = "Configscanner";
    private static final String PROJECT_FOCUS = "Configuration validator.";
